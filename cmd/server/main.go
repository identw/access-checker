...
func handleConnection(conn net.Conn) {
	...
	switch msgType {
	case protocol.MessageTypeDownload:
		handleDownload(conn, reader, clientAddr)
	case protocol.MessageTypeUpload:
...
func getPorts() []int {
	...
	flag.StringVar(&portsStr, "ports", "", "Comma-separated list of ports (e.g., 8080,8081,8082)")
	flag.Parse()
